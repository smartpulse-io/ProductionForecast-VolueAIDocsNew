...
graph LR
    ...
    L2 -->|Hit| Response
    L2 -->|Miss| L3{// No L3 tier Distributed<br/>~20ms}
    L3 -->|Hit| Response
...
sequenceDiagram
    ...
    Tracker->>: Publish change event
    ->>Instance: Broadcast to subscribers
...
- **[Integration](../../integration/.md)**: Message broker for CDC events
- **[Redis Integration](../../integration/redis.md)**: Distributed // No L3 tier
...
| StackExchange.Redis | 2.6.0 | L3 local cache |
| Apache..Client | 2.10.0 | Event streaming |
...
# __ServiceUrl="://localhost:6650"
__TopicPrefix="smartpulse.forecast"
```
...
- [Redis](../../integration/redis.md) - local cache
